...
class AuthorRepositoryTest {
    ...
    void manyToManyTest() {
        ...
        Book book3 = givenBook("책첵1");
        Book book4 = givenBook("책첵2");

        Author author1 = givenAuthor("베리");
        Author author2 = givenAuthor("모리");

        // ManyTOMany 설정
//        book1.addAuthor(author1);   // 저자 베리
//        book2.addAuthor(author2);   // 저자 모리
//        book3.addAuthor(author1, author2); // 저자 베리, 모리
//        book4.addAuthor(author2, author1); // 저자 베리, 모리
