...
//        System.out.println(null + null);
    ...
    public void sample4(Model model) {
        ...
        // th:if 에서 어떻게 판정될까?
        model.addAttribute("test1", "aaa"); // '참' 으로 판정
        model.addAttribute("test2", "");    // '참' 으로 판정
        model.addAttribute("test3", null);  // '거짓' 으로 판정
        model.addAttribute("test4", false); // '거짓' 으로 판정
    }


    // thymeleaf 에 랜더링 하는 2가지 방식
     ...
     */
    @GetMapping("/sample6")
    public void sapmple6(Model model) {
