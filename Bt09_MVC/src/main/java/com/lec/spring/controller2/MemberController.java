...
@Controller
@RequestMapping("/member") // ← 이 컨트롤러는 "/member" 로 시작하는 url 에 맵핑된다.
public class MemberController {

    @RequestMapping("/save") // URL mapping -> "/mamber" + "/save" => "/member/save"
    @ResponseBody
...
//    @RequestMapping("/search") //  /member/search 가 이미 있기 때문에 죽음.
