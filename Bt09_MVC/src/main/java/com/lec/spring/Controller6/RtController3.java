...
// ----------------------------------------------------------------
    ...
    public String mapTest1(){
        String url = "http://localhost:8080/server/0"; // 반드시 절대경로 사용해야함!
    ...
    public String mapTest3(){
        String url = "http://localhost:8080/server/1"; // 반드시 절대경로 사용해야함!
    ...
    // 1. 상속받은 객체
    // 2. JSON 배열은 List<> 또는 Array 로 받을 수 있음
    @RequestMapping("/mapTest4")
    public String mapTest4(){
        String url = "http://localhost:8080/server/2"; // 반드시 절대경로 사용해야함!
    ...
    public String mapTest5(){
        String url = "http://localhost:8080/server/3"; // 반드시 절대경로 사용해야함!
