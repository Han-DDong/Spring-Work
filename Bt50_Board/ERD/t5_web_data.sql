-- 기존테이블 내용 삭제
-- 삭제는 자식 -> 부모 순서로 내용 삭제 해야함
-- DELETE 는 WHERE 절 없으면 에러뜸
...
('ROLE_MEMBER'), ('ROLE_ADMIN'); -- spring security 에서는 권한 접두 앞에 'ROLE' 을 붙힘

-- 샘플 t5_user
INSERT INTO t5_user (username, password, name, email) VALUES
('USER1', '$2a$10$R5YnGt4wn/H3bC6HbpWZj.3yUx5lTF9r9rHMtB6.x5esDZ.7cLK46', '회원1', 'user1@mail.com'),
('USER2', '$2a$10$YflBT3KZjqX02rSEmC2Qn.wPlD0NFPoYJhdfgWuYq9bUHQOlsgX6C', '회원2', 'user2@mail.com'),
('ADMIN1', '$2a$10$mq5grW0b3uc540PNlq5DaeE2hzJGyoGxOANGCEk7NnALUd./Womjy', '관리자1', 'admin1@mail.com');

-- 샘플 사용자-권한
INSERT INTO t5_user_authorities VALUES
(1, 1), -- 1번 유저 MEMBER 권한, 2번 유저는 권한없음
(3, 1), -- 3번은 관리자여서 다 모든 권한 있음.
(3, 2);
