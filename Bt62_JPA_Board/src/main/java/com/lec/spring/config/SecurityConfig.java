...
@Configuration // 클래스 자체를 bean 으로 생성
@EnableWebSecurity
...
//        return web -> web.ignoring().anyRequest(); // WebSecurityCustomizer 이걸 리턴해주는 구현체  // 어떠한 request 도 Security 가 무시함
//    }


    // OAuth2 Client
    // 구글 로그인 완료된 뒤에 후처리 해주는 용도
    @Autowired
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                 ...
                 * 브라우저에서 403에러는 security 에 관한 에러!!
                 **********************************************/
                ...
                .formLogin(form -> form
                        ...
                        // .usernameParameter("aaa") // 기본 name = "username" 이여야 함
                        // .passwordParameter("bbb") // 기본 name = "password" 이여야 함
                ...
                .logout(httpSecurityLogoutConfigurer -> httpSecurityLogoutConfigurer
                        ...
                        // .logoutSuccessUrl("/home") // 로그아웃 성공 후 redirect url (로그아웃하면 홈으로 이동)
                        ...
                        // .logoutSuccessHandler <- 이게 있으면  .logoutSuccessUrl 이게 작동하지 않음!!
