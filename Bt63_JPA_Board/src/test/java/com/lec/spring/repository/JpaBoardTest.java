...
public class JpaBoardTest {
    ...
    public void init() {
        ...
        userRepository.saveAll(List.of(user1, user2, admin1));  // INSERT
        ...
        {
            // 1번 댓글의 작성자 정보 가져오기
            Comment commnet = commentRepository.findById(1L).orElse(null);
            System.out.println(commnet.getUser());  // user1
            System.out.println(commnet.getUser().getAuthorities()); // ROLE_MEMBER
        }
