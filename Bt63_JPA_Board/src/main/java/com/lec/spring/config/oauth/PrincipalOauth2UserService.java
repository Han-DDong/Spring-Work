...
//    private PasswordEncoder passwordEncoder; // 회원 가입시 PW 인코딩
    ...
    //  provider 로부터 받은 userRequest 데이터에 대한 후 처리 진행
    @Override
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        System.out.println("""
                ...
                , oAuth2User.getAttributes()    // Map<String, Object> 리턴 <- 사용자 프로필 정보
        ));
        ...
        if (user == null) { // 신규회원인 경우 회원가입 진행
            ...
            if (cnt > 0) {
                ...
                user = userService.findByUsername(username);    // 다시 읽어옴. regDate 정보 등등...
            } else {
